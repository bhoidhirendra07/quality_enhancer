...
export default function OptionsSection({ onEnhance }) {
  ...
  return (
    <section id="section-options" className="glass-card rounded-2xl p-6 sm:p-8 mb-6 section-enter" aria-label="Enhancement options">
      ...
      {/* Level selector */}
      <div className="mb-6">
        <label className="block text-sm font-medium text-gray-300 mb-3">Enhancement Level</label>
      ...
      <div className="flex items-center justify-between py-3 border-t border-white/5">
        <div>
          <p className="text-sm font-medium text-gray-300">Add Watermark</p>
          <p className="text-xs text-gray-600 mt-0.5">Adds &quot;Enhanced by QualityAI&quot; text overlay</p>
        </div>
